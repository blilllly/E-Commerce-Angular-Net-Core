...
export class InstrumentService {
  ...
  getProductos(): Observable<Instrument[]> {
    return this.http.get<Instrument[]>( `${ this.baseUrl }/Producto` );
  }

  getProductoXId( id: number ): Observable<Instrument> {
    return this.http.get<Instrument>( `${ this.baseUrl }/Producto/${ id }` );
  }

  postProductos( instrument: Instrument ): Observable<Instrument> {
    const header = new HttpHeaders({
      'Content-Type': 'application/json',
      'Authorization': `bearer ${localStorage.getItem('token')}`
    })
    return this.http.post<Instrument>( `${ this.baseUrl }/Producto`, instrument, {headers: header} );
  }

  putProducto( instrument: Instrument): Observable<Instrument> {
    const header = new HttpHeaders({
      'Content-Type': 'application/json',
      'Authorization': `bearer ${localStorage.getItem('token')}`
    })
    return this.http.put<Instrument>( `${ this.baseUrl }/Producto`, instrument, {headers: header} );
  }
  ...
  deleteProducto( id: number ): Observable<any> {
    ...
    return this.http.delete<any>( `${ this.baseUrl }/Producto/${ id }`, {headers: header} );
  }
